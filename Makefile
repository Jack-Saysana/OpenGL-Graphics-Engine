win:
	gcc -Wall -Werror -I./include -LC:/msys64/mingw64/bin -L:/msys64/mingw64/lib -o main ./src/main.c ./src/glad.c ./src/shader.c ./src/model_loader.c ./src/model.c ./src/obj_preprocessor.c -l:glfw3.dll -l:libfreeglut.dll -l:libcglm.a
